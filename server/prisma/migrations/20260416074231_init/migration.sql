...
CREATE TABLE "GITag" (
    ...
    CONSTRAINT "GITag_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "_GITagToProduct" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_GITagToProduct_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_GITagToProduct_B_index" ON "_GITagToProduct"("B");
...
-- AddForeignKey
ALTER TABLE "_GITagToProduct" ADD CONSTRAINT "_GITagToProduct_A_fkey" FOREIGN KEY ("A") REFERENCES "GITag"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_GITagToProduct" ADD CONSTRAINT "_GITagToProduct_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
